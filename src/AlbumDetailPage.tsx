...
import { adminDetailFor, adminTrackList, adminVideoLink, parseAdminCredits, selectAdminSummary } from './content/adminAlbums';
...
export function AlbumDetailPage({ locale, slug }: { locale: Locale; slug: string }) {
  ...
  const admin = adminDetailFor(`album/${slug}`);
